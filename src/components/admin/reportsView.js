  ...
  return `
    <div>
      ...
      <div style="margin-bottom: 1.5rem; display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 1rem;">
        ...
        <button class="btn-secondary" id="exportReportsCsvBtn" style="min-height: 46px; font-size: 0.95rem;">
      ...
      <div class="table-responsive-wrapper">
        <div style="padding: 1.25rem 1.5rem; border-bottom: 1px solid #e2e8f0; display: flex; align-items: center; justify-content: space-between;">
          <h3 class="font-headline-sm" style="color: var(--on-surface); margin: 0;">Last Ten Session Records</h3>
          ...
          <tbody>
            ${sessions.slice(0, 10).map((s) => `
              <tr>
                ...
                <td style="text-transform: capitalize; color: var(--secondary); font-weight: 600;">
                  ${s.skinType}
                </td>
                ...
                <td>
                  ${s.hasSevere ? `
                    <span style="display: inline-flex; align-items: center; gap: 4px; padding: 2px 8px; border-radius: 9999px; font-size: 0.72rem; font-weight: 700; background: var(--warning-wash); color: var(--tertiary); border: 1px solid #fcd34d;">
                ...
                <td style="color: var(--outline); font-size: 0.8rem;">
